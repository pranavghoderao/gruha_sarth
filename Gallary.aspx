...
<html>
<head>
<title>Gruha Sarth a Home Website  | Gallery ::GruhaSarth</title>
...
<section class="wthree-row w3-gallery py-lg-5 py-md-4 py-md-3 py-2" id="gallery">
	...
	<h3 class="heading text-center text-uppercase mb-lg-5 mb-md-4 mb-sm-3 mb-3">Our Gallery</h3>
		<ul class="portfolio-categ filter mb-lg-5 mb-md-4 mb-sm-3 mb-3 text-center">
			...
			<li class="cat-item-1">
				<a href="#" title="Category 1">Carpentry</a>
			</li>
			<li class="cat-item-2">
				<a href="#" title="Category 2">InteriorDesign</a>
			</li>
			<li class="cat-item-3">
				<a href="#" title="Category 3">Plumbing</a>
			</li>
			<li class="cat-item-4">
				<a href="#" title="Category 4">Painting</a>
			</li>
		</ul>
...
<div class="w3_mg">
<h3>Gruha Sarth</h3>
<p class=" my-lg-4 my-md-3 my-sm-2 my-2">GruhaSarth is a complete end to end solution for your daily social life. It help you to connect with your neighbourhood digititally with just a click.</p>
	</div>
	</div>
		</section>
...
<div class="copyright">
			<p>© 2018 Gruha Sarth. All Rights Reserved | Design by GruhaSarth</p>
