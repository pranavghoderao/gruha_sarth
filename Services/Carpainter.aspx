<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Carpainter.aspx.cs" Inherits="Services_Carpainter" %>
    ...
    <div class="container-sm ,container-md,container-lg,container-xl">
        ...
        <form id="form1" runat="server">
            ...
            <div class="table-responsive,m-lg-4,m-sm-4,m,font-weight-bold,fa-2x,font">
                <asp:DataGrid ID="DataGrid1" class="table ,table table-hover" runat="server" Font-Size="16pt" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
